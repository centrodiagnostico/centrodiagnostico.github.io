...
>
	...
	<xsl:template match="/*">
		<form class="d-flex" id="buscador">
			<input class="form-control me-2" type="search" placeholder="Buscar..." aria-label="Buscar..." oninput="xo.stores['#estudios'].documentElement.set('state:search',this.value)" value="{@state:search}"/>
